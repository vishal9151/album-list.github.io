    ...
    return (
        <div>
            ...
            <button
                ...
                className="bg-blue-500 hover:bg-white font-semibold text-white hover:text-blue-500 px-2 py-1 rounded border hover:border-green-500"
            >Update</button>
            ...
            {selectedUpdatedAlbum &&
                ...
                <div className='w-screen h-screen fixed z-50 top-0 left-0 flex items-center justify-center'
                    ...
                    <div ref={updateAlbumRef} className=" w-[50%] rounded-lg  "
